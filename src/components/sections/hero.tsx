    ...
    <TooltipTrigger asChild>
      <span
        className={cn(
          ...
          "cursor-default text-edge-outline font-display sm:text-7xl md:text-9xl inline-block"
        )}
      >
    ...
    >
      theres something waiting for you in devtools
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://drive.google.com/file/d/1S-0dvWUngisJ8T7MHINlLgFu8f2rATzN/view?usp=drive_link"
                  }
                  target="_blank"
                  className="flex-1"
                >
