...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.C]: {
    ...
    name: "c",
    label: "C",
    shortDescription: "the Swiss Army knife of programming languages, no cap! �🔧",
    color: "#1110ff",
  ...
  [SkillNames.CPP]: {
    ...
    label: "C++",
    shortDescription:
      "the OG of object-oriented programming, no cap! ☕🔥",
    color: "#007acc",
  ...
  [SkillNames.GO]: {
    ...
    name: "go",
    label: "Go",
    shortDescription: "the ultimate backend language, no cap! 🐹🔥",
    color: "#61dafb",
  ...
  [SkillNames.HTML]: {
    ...
    label: "HTML",
    shortDescription:
      "the style guru of the web, no cap! 🎨🔥",
    color: "#41b883",
  ...
  [SkillNames.CSS]: {
    ...
    name: "css",
    label: "CSS",
    shortDescription: "the style guru of the web, no cap! 🎨🔥",
    color: "#41b883",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg",
  },
  [SkillNames.JS]: {
  ...
  [SkillNames.GRAPHQL]: {
    ...
    name: "graphql",
    label: "GraphQL",
    shortDescription: "the query language for APIs, no cap! 📈🔥",
    color: "#e535ab",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "the reliable relational database, no cap! �💾",
    color: "#00758f",
  ...
  [SkillNames.REDIS]: {
    ...
    name: "redis",
    label: "Redis",
    shortDescription: "the in-memory data structure store, no cap! 🧠💾",
    color: "#dc382d",
  ...
  [SkillNames.FLASK]: {
    ...
    name: "flask",
    label: "Flask",
    shortDescription: "the lightweight WSGI web application framework, no cap! 🐍🔥",
    color: "#000000",
  ...
  [SkillNames.FASTAPI]: {
    ...
    name: "fastapi",
    label: "FastAPI",
    shortDescription: "the modern, fast (high-performance), web framework for building APIs with Python 3.6+ based on standard Python type hints.",
    color: "#009688",
  ...
  [SkillNames.PT]: {
    ...
    name: "pt",
    label: "PyTorch",
    shortDescription: "the deep learning framework that’s redefining AI, no cap! 🐼🔥",
    color: "#ee4c2c",
